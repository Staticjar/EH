...
|-------------------------------------------------------------------
|  Version (v027a), modified by Arthur Nishimoto, allows
...
|-------------------------------------------------------------------
|  Version (v027b), by Arthur Nishimoto, updated for Unity 5 (Pro version 
|  no longer required)
|-------------------------------------------------------------------
...
|-------------------------------------------------------------------
|  Instructions: (NOTE: REQUIRES UNITY 4 PRO OR UNITY 5 PERSONAL/PRO) 
...
function DoWindow (windowID : int) {
	GUILayout.BeginHorizontal();
		...
		GUILayout.BeginVertical();
			...
			GUILayout.BeginHorizontal();
			    GUILayout.Space(15);
			    autoSetRowsAndColumns = GUILayout.Toggle(autoSetRowsAndColumns, "Automatically Set Rows and Columns");
			    GUILayout.FlexibleSpace();
